    ...
    render() {
        return (
            <div className="puncSponsor">
                ...
                <div className="PS">
                   <h1>1 year adoption</h1>
                   <p>For 900$ adopt an animal for 1 whole year!  Not only will you be providing invaluable care, you will also receive a great gift pack.</p>
