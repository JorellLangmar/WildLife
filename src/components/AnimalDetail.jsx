              ...
              <Grid.Column width={9}>
                <div className="mid-part">
                  ...
                  <div className="ani-id desc">
                    ...
                    <p>
                      {this.state.animal.description}: Lorem ipsum dolor sit
          ...
          <div className="sponsorship">
            <div className="why-sponsor">
              ...
              <p className="text-sponsor">
                ...
                further: now you can sponsor the animal of your choice and help
                to protect an endangered species! Thanks to your donation,
                you’ll be contributing to the well-being of the animals at the
                Sanctuary (veterinary equipment or enclosures, animal food,
                environmental enrichment programmes, various expenses) or the
                protection of endangered species in their native habitats
                (on-site conservation programmes).
              </p>
            </div>
